...
class AdaINGen_v2(nn.Module):
    ...
    def encode(self, images):
        ...
        content = self.enc_content(images) #(1,256,32,32)        
        
        return content, mus, logvar

    def encode_txt(self, style_ord, txt_org2trg, txt_lens):
        mu, logvar, packed_outs = self.enc_txt(style_ord, txt_org2trg, txt_lens)
        return mu, logvar, packed_outs
